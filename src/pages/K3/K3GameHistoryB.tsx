...
export function K3GameHistoryB({
  show,
  page,
  isEnd,
  data,
      ...
      <table className="w-full">
        <thead>
          <tr className="text-white text-2xs h-8 ">
            ...
            <th className="font-medium w-1/4 bg-[#fd565c]" colSpan={3}>Results</th>
            <th className="font-medium w-1/4 bg-[#fd565c] rounded-tr-md">Number</th>
          </tr>
        </thead>
        <tbody>
          {data?.map((item) => (
