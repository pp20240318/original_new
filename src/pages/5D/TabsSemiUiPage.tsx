...
export const TabsSemiUiPage = ({
  ...
  return (
    <div className="flex flex-col items-center bg-base-900 mt-4 mb-4 p-3">
      <div className="tabs-bar-top">
        <div className="overflow-list">
          {(active > 0 || scrollActive > 0) && (
            ...
            >
              <button className="bg-transparent text-[#ECF24F]">
      ...
      <div className="w-full text-white tab-content">
        {tabs.map((tab, index) => (
